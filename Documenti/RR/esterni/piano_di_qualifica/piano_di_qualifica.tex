...
\def\DOCUMENTO       {Piano di Qualifica}        %titolo del documento
\def\PROGETTO           {\textbf{MyTalk}}               %titolo del progetto
\def\VERSIONE                        {0.1}                        %inserire qui la versione attuale (di base 0.1)
\def\CREAZIONE		{03/12/2012}              %data di creazione
\def\ULTIMA_MOD		{03/12/2012}              %data di ultima modifica
...
\textbf{Sommario} \\
Questo documento si prefigge di regolamentare le operazioni di verifica e validazione del gruppo {\NOME_GRUPPO } nello svolgimento del progetto \PROGETTO.
...
\hline\hline
Palmisano Maria Antonietta & Inizio stesura documento & 03/12/2012 & 0.1 \\\hline
\hline
%*******************MODIFICA QUI*****************
...
\subsection{Gestione anomalie e discrepanze}
