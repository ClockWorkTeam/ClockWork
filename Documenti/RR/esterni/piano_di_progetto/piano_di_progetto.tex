...
\textbf{Sommario} \\
Questo documento vuol definire la pianificazione delle attivit\`a del gruppo {\textit{clockwork}} nello svolgimento del progetto \PROGETTO.
...
\hline\hline
Palmisano Maria Antonietta & Inizio stesura documento & 02/12/2012 & 0.1 \\\hline
\hline
%*******************MODIFICA QUI*****************
...
\subsection{Analisi (AN)}
\subsection{Progettazione Architetturale (PA) }
\subsection{Progettazione di Dettaglio e Codifica (PDC)}
\subsection{Verifica e Validazione (VV)}

\section{Preventivo}
\subsection{Prospetto Orario}
\subsection{Prospetto Economico}

\section{Analisi Rischi}
\subsection{Strumenti}
\subsubsection{Livello di rischio}
\subsubsection{Caratteristiche}
\subsubsection{Contromisure}


\subsection{Aumento dei costi}
\subsubsection{Livello di rischio}
\subsubsection{Caratteristiche}
\subsubsection{Contromisure}


\subsection{Problemi dei componenti}
\subsubsection{Livello di rischio}
\subsubsection{Caratteristiche}
\subsubsection{Contromisure}
