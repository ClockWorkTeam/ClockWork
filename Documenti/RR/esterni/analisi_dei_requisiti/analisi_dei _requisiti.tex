...
\def\DOCUMENTO       {Analisi dei Requisiti}        %titolo del documento
\def\PROGETTO                 {\textbf{MyTalk}}          %nome del progetto
\def\VERSIONE                        {0.1}                     %inserire qui la versione attuale (di base 0.1)                                                                                  
\def\CREAZIONE		{04/12/2012}              %data di creazione
\def\ULTIMA_MOD		{04/12/2012}              %data di ultima modifica
...
%Prima pagina senza intestazione nè piè di pagina									
\thispagestyle{empty}
...
\textbf{Sommario} \\
Questo documento presenta l'analisi dei requisiti che il sistema {\PROGETTO} dovr\`a rispettare, individuati a partire dal capitolato e dai successivi incontri col proponente Zucchetti S.p.a..
%Fine zona centrata
\end{center}
...
\hline\hline
Palmisano Maria Antonietta & Inizio stesura documento & 05/12/2012 & 0.1 \\\hline
\hline
%*******************MODIFICA QUI*****************
...
\subsubsection{Processi produttivi e modalit\`a d'uso}
\subsubsection{Piattaforma di esecuzione ed interfacciamento con l'ambiente di installazione e uso}
